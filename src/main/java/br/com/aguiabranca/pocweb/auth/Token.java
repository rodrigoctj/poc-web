...
public class Token {
	...
	Token(String accessToken, long expiresIn, long refreshExpiresIn, String refreshToken, String tokenType,
			String idToken, int notBeforePolicy, String sessionState, Map<String, Object> otherClaims, String scope) {
		if (accessToken == null) {
